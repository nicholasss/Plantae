...
hurl \
  ...
  --variable 1_plant_type_maxtc=35.0 \
  --variable 1_plant_type_mintc=10.0 \
  --variable 1_plant_type_maxph=80.0 \
  --variable 1_plant_type_minph=30.0 \
  ...
  --variable 2_plant_type_maxtc=30.0 \
  --variable 2_plant_type_mintc=10.0 \
  --variable 2_plant_type_maxph=70.0 \
  --variable 2_plant_type_minph=30.0 \
  ...
  --variable 3_plant_type_maxtc=30.0 \
  --variable 3_plant_type_mintc=10.0 \
  --variable 3_plant_type_maxph=60.0 \
  --variable 3_plant_type_minph=20.0 \
  ...
  --variable 4_plant_type_maxtc=40.0 \
  --variable 4_plant_type_mintc=5.0 \
  --variable 4_plant_type_maxph=50.0 \
  --variable 4_plant_type_minph=10.0 \
